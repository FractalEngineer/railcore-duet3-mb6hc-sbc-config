...
G0 X-33 Y80 F3000               ; move to Dock Re-entry staging position 
M400                          ; wait for moves to finish

G0 X-33 Y50  F3000              ; move to the entry position for the dock
M400                          ; wait for moves to finish

G0 X-33 Y8  F300                ; move into the dock position
M400                          ; wait for moves to finish
G4 P250                       ; pause 250 usecs 

G0 X-4 Y8 F6000               ; move to the side adjacent to the dock swiping the probe off
G0 X100 Y8 F3000              ; move to the side adjacent to the dock swiping the probe off
M400                          ; wait for moves to finish
